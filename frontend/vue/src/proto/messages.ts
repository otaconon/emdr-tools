  ...
  fromJSON(object: any): WebSocketMessage {
    return {
      createSessionRequest: isSet(object.createSessionRequest)
        ...
        : isSet(object.create_session_request)
        ? CreateSessionRequest.fromJSON(object.create_session_request)
        : undefined,
      joinSessionRequest: isSet(object.joinSessionRequest)
        ? JoinSessionRequest.fromJSON(object.joinSessionRequest)
        : isSet(object.join_session_request)
        ? JoinSessionRequest.fromJSON(object.join_session_request)
        : undefined,
      createSessionResponse: isSet(object.createSessionResponse)
        ? CreateSessionResponse.fromJSON(object.createSessionResponse)
        : isSet(object.create_session_response)
        ? CreateSessionResponse.fromJSON(object.create_session_response)
        : undefined,
      joinSessionResponse: isSet(object.joinSessionResponse)
        ? JoinSessionResponse.fromJSON(object.joinSessionResponse)
        : isSet(object.join_session_response)
        ? JoinSessionResponse.fromJSON(object.join_session_response)
        : undefined,
...
export const CreateSessionResponse: MessageFns<CreateSessionResponse> = {
  ...
  fromJSON(object: any): CreateSessionResponse {
    return {
      ...
      sessionUrl: isSet(object.sessionUrl)
        ? globalThis.String(object.sessionUrl)
        : isSet(object.session_url)
        ? globalThis.String(object.session_url)
        : "",
    };
  },
